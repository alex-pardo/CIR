...
The \textbf{Anti-collision system} code runs on the server side and is able to stop the MASHI when an obstacle is close to the robot autonomously. Also blocking the user to move the MASHI forward if the obstacle still in the path.\\
